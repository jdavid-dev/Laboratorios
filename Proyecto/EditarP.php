...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_GET['id'])) {
    ...
    $sql = "UPDATE registro_p 
            SET nombre = :nombre, correo = :correo, asignatura = :asignatura
            WHERE id = :id";
    ...
    <legend>Asignatura</legend>
            <div class="form-group">
              <label for="asignatura">
                <select class="form-control" id="asignatura" name="asignatura" value="<?php echo htmlspecialchars($row['asignatura']); ?>" required>
